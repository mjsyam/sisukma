            ...
            <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <?php $no++ ;?>
                        <tr>
                            <td>{{ $no }}</td>
                            <td><a href="{{ route(WAREKTOR . '.keluar.show', $item->id) }}">{{ $item->keperluan_surat }}</a></td>
                            ...
                            <td>
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="{{ route(WAREKTOR. '.keluar.show', $item->id) }}" title="Teruskan Surat" class="btn btn-primary btn-sm">
