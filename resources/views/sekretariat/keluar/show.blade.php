...
@section('content')
  ...
  <div class="col-md-9">
    ...
    <div class="col-md-9">
    <div class="card shadow mb-4">
      @if($item->status_surat == 8)
      {!! Form::model($item, [
          'route' => [ SEKRETARIAT. '.keluar.update',$item->id ],
          'method' => 'put',
          'files' => true
        ])
      !!}
      @else
      {!! Form::model($item, [
          'route' => [ SEKRETARIAT. '.keluar.tolak',$item->id ],
          'method' => 'put',
          'files' => true
        ])
      !!}
      ...
      <input type="hidden" name="status_surat" value="9">
      <input type="hidden" name="tanggal_ttd" value="{{date('d/m/Y')}}">
      <!-- Card Header - Accordion -->
      ...
      <div class="collapse show" id="axe3">
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-group col-md-8">
              <label for="file_surat">Upload Surat (Surat keluar yang sudah berstempel)</label>
              <div class="input-group mb-3">
          ...
          <div class="col-sm-2" style="text-align: right">
              <a href="{{ route(SEKRETARIAT . '.keluar.setujui', $item->id) }}" class="btn btn-lg btn-success form-control">Setujui</a>
          </div>
          @endif
          </div>
          {!! Form::close() !!}
