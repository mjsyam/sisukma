            ...
            <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <?php $no++ ;?>
                        <tr>
                            <td>{{ $no }}</td>
                            <td><a href="{{ route(UNIT . '.keluar.create') }}">{{ $item->keperluan_surat }}</a></td>
                            ...
                            <td>
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="{{ route(UNIT . '.keluar.show', $item->id) }}" title="{{ trans('app.edit_title') }}" class="btn btn-primary btn-sm"><span class="ti-pencil"></span></a></li>
                                    @endif
                                    @if($item->status_surat !== 8 && $item->status_surat !== 9)
                                    <li class="list-inline-item">
