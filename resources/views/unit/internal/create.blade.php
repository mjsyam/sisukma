...
@section('content')
    ...
    <div class="card shadow mb-4">
      ...
      <a href="#axe3" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="axe3">
        <h6 class="m-0 font-weight-bold text-info">Data Surat Internal Unit</h6>
      </a>
      ...
      <div class="collapse show" id="axe3">
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-group col-md-8">
              {!! Form::mySelect('jenis_tata_naskah', 'Jenis Surat', config('variables.jenis_tata_naskah'), ['class' => 'form-control select2', 'required']) !!}
              @error('jenis_tata_naskah')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
              @enderror
          ...
          <div class="form-group">
            <div class="form-group col-md-8">
              ...
              <div class="input-group mb-3">
              <input id="tujuan_surat" type="text" class="form-control @error('tujuan_surat') is-invalid @enderror" name="tujuan_surat" autocomplete="tujuan_surat" value="{{ old('tujuan_surat') }}" required>
              </div>
