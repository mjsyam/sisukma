...
@section('page-header')
    @if(Route::is(UNIT . '.surat.index') )
    Daftar Surat <small>menunggu persetujuan</small>
    @elseif(Route::is(UNIT . '.surat.disetujui') )
...
@section('content')
    ...
    <div class="mB-20 pull-right">
        <a href="{{ route(UNIT . '.surat.approve.all') }}" class="btn btn-success">
            Setujui Semua
        </a>
    </div>
    @endif
                        ...
                        <tr>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a href="{{ route(UNIT . '.surat.approve', $item->id) }}" title="Setujui Surat" class="btn btn-success btn-sm">
