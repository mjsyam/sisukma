...
class SuratKeluarController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('rektor.keluar.show', compact('item'));
    }
    ...
    public function tolak(Request $request, $id)
    {
        ...
        $items->save();
        return redirect()->route(REKTOR. '.keluar.index')->withSuccess('Surat keluar berhasil ditolak');
    }
    ...
    public function setujui(Request $request, $id)
    {
        ...
        $item->update($data);
        return redirect()->route(REKTOR. '.keluar.index')->withSuccess('Surat keluar berhasil disetujui');
    }
}