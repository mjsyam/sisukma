...
class SuratMasuk extends Model
{
    ...
    protected $fillable = ['id_users','no_surat', 'perihal_surat', 'tanggal_surat', 'tujuan_surat', 'pengirim', 'status_surat', 'keterangan_surat', 'file_surat', 'tujuan_pimpinan', 'disposisi'];
